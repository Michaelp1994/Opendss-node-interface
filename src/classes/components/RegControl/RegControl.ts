  ...
  implements HasKeys<RegControlInterface>
{
  ...
  constructor(options: RegControlInterface);
  constructor(name: string, options?: OmitName<RegControlInterface>);
  constructor(
    nameOrOptions: string | RegControlInterface,
    options?: OmitName<RegControlInterface>,
  ) {
    super(nameOrOptions);
    if (typeof nameOrOptions === "string") {
      const { transformer, ...optOptions } = options!;
      this.transformer = transformer;
      Object.assign(this, optOptions);
    } else {
      const { name, transformer, ...otherOptions } = nameOrOptions;
      this.transformer = transformer;
