  ...
  implements HasKeys<StorageControllerInterface>
{
  ...
  constructor(options: StorageControllerInterface);
  constructor(name: string, options?: OmitName<StorageControllerInterface>);
  constructor(
    nameOrOptions: string | StorageControllerInterface,
    options?: OmitName<StorageControllerInterface>,
  ) {
    super(nameOrOptions);
