...
import BaseElementInterface from "@elements/BaseElements/BaseElementInterface";

/**   Circuit Element, PD Element  */
export default interface AutoTransInterface extends BaseElementInterface {
  ...
  /** Default=1 ppm.  Parts per million of AutoTrans winding VA rating connected to ground to protect against accidentally floating a winding without a reference.
